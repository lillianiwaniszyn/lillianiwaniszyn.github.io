...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Course" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Tutor" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Module" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Is_enrolled" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Tutors_a" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Includes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Student" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
