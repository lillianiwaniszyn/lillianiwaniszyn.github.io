...
class tDAL
{
	var $tblGemini_mdb__Course;
	var $tblGemini_mdb__Includes;
	var $tblGemini_mdb__Is_enrolled;
	var $tblGemini_mdb__Module;
	var $tblGemini_mdb__Student;
	var $tblGemini_mdb__Tutor;
	var $tblGemini_mdb__Tutors_a;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "Course", "varname" => "Gemini_mdb__Course", "altvarname" => "Course", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Includes", "varname" => "Gemini_mdb__Includes", "altvarname" => "Includes", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Is_enrolled", "varname" => "Gemini_mdb__Is_enrolled", "altvarname" => "Is_enrolled", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Module", "varname" => "Gemini_mdb__Module", "altvarname" => "Module", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Student", "varname" => "Gemini_mdb__Student", "altvarname" => "Student", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Tutor", "varname" => "Gemini_mdb__Tutor", "altvarname" => "Tutor", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
		$this->lstTables[] = array("name" => "Tutors_a", "varname" => "Gemini_mdb__Tutors_a", "altvarname" => "Tutors_a", "connId" => "Gemini_mdb", "schema" => "", "connName" => "Gemini.mdb");
	}
