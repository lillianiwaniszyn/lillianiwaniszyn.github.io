...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 3;
		$data["connId"] = "Gemini_mdb";
		$data["connName"] = "Gemini.mdb";
		$data["connStringType"] = "file";
		$data["connectionString"] = "file;C:\\\\Users\\\\Malek\\\\Documents\\\\PHPRunnerProjects\\\\Gemini\\\\Gemini.mdb;;;Microsoft.Jet.OLEDB.4.0;1;access"; //currently unused
		
		$this->_connectionsIdByName["Gemini.mdb"] = "Gemini_mdb";
		...
		$data["connInfo"][0] = "C:\\Users\\Malek\\Documents\\PHPRunnerProjects\\Gemini\\Gemini.mdb";
		$data["connInfo"][1] = "";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "Microsoft.Jet.OLEDB.4.0";
		$data["connInfo"][4] = "1";
		$data["connInfo"][5] = "access"; //currently unused
		$data["connInfo"][6] = ""; //currently unused
		$data["ODBCString"] = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" . getabspath("db\\Gemini.mdb") . ";Jet OLEDB:Database Password=;User ID=";
		$connectionsData["Gemini_mdb"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["Course"] = "Gemini_mdb";
		$connectionsIds["Tutor"] = "Gemini_mdb";
		$connectionsIds["Module"] = "Gemini_mdb";
		$connectionsIds["Is_enrolled"] = "Gemini_mdb";
		$connectionsIds["Tutors_a"] = "Gemini_mdb";
		$connectionsIds["Includes"] = "Gemini_mdb";
		$connectionsIds["Student"] = "Gemini_mdb";
