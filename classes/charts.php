...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("Course" == $this->chrt_array['tables'][0])
			return true;
		if("Tutor" == $this->chrt_array['tables'][0])
			return true;
		if("Module" == $this->chrt_array['tables'][0])
			return true;
		if("Is_enrolled" == $this->chrt_array['tables'][0])
			return true;
		if("Tutors_a" == $this->chrt_array['tables'][0])
			return true;
		if("Includes" == $this->chrt_array['tables'][0])
			return true;
